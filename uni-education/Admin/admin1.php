                      ...
                      <form class="form-horizontal style-form" method="POST">
						  ...
						  <div class="form-group">
							...
							<label class="col-sm-2 col-sm-2 control-label">Faculty :</label>
                              <div class="col-sm-10">
                                  <select class="form-control"  id="type_sele" name="faculty1" >
							...
							<br/>
							<button type="submit" class="btn btn-round btn-success" name="report_form">Generate Reports</button>
