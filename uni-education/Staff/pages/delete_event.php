...
<section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Delete Event Handling</h3>        	
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" method="POST" name="events"  onSubmit="return formValidation()"  >
						...
						<div class="form-group">
                              ...
                              <div class="col-sm-10">
							<button type="submit" class="btn btn-round btn-success" name="delete">Delete</button>							
						...
						{
						$data="DELETE FROM  schedule_events WHERE eid='$id'";
