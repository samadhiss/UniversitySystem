...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul for="sub_links" font="18px">
		<li><a href="#" id="link_1">|Show Events|</a></li>
...
<div id="div_1">
	<section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Show Event</h3>   
				<div align="center">
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" method="POST">
						  ...
						  if(isset($_POST["add"]))
								...
								$data1="INSERT INTO apply_events (ename,sname,semail)VALUES('$Event_Name','$Student_Name','$Student_email')";
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" method="POST">
						  ...
						  if(isset($_POST["add"]))
								...
								$data1="INSERT INTO enrollcourse_paymnets VALUES( '$Student_Name', '$Student_ID', '$Student_Email_Address', '$Course', '$Course_Fee', '$Bank', '$Method',  '$Telephone','$Paid_Date','$Select_the_Group')";
